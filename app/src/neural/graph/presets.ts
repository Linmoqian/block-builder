...
/** YOLOv8-small backbone + head (2x nano channels) */
export const YOLOV8_SMALL: GraphIR = {
  nodes: [
    { id: 'input_0', type: 'Input', position: { x: 300, y: 0 }, params: { channels: 3, height: 640, width: 640 } },
    { id: 'conv_0', type: 'Conv', position: { x: 300, y: 120 }, params: { out_channels: 32, kernel_size: 3, stride: 2 } },
    { id: 'conv_1', type: 'Conv', position: { x: 300, y: 240 }, params: { out_channels: 64, kernel_size: 3, stride: 2 } },
    { id: 'c2f_0', type: 'C2f', position: { x: 300, y: 360 }, params: { out_channels: 64, n: 2 } },
    { id: 'conv_2', type: 'Conv', position: { x: 300, y: 480 }, params: { out_channels: 128, kernel_size: 3, stride: 2 } },
    { id: 'c2f_1', type: 'C2f', position: { x: 300, y: 600 }, params: { out_channels: 128, n: 2 } },
    { id: 'conv_3', type: 'Conv', position: { x: 300, y: 720 }, params: { out_channels: 256, kernel_size: 3, stride: 2 } },
    { id: 'c2f_2', type: 'C2f', position: { x: 300, y: 840 }, params: { out_channels: 256, n: 2 } },
    { id: 'conv_4', type: 'Conv', position: { x: 300, y: 960 }, params: { out_channels: 512, kernel_size: 3, stride: 2 } },
    { id: 'c2f_3', type: 'C2f', position: { x: 300, y: 1080 }, params: { out_channels: 512, n: 1 } },
    { id: 'sppf_0', type: 'SPPF', position: { x: 300, y: 1200 }, params: { out_channels: 512, kernel_size: 5 } },
    // Head
    { id: 'upsample_0', type: 'Upsample', position: { x: 300, y: 1360 }, params: { scale_factor: 2, mode: 'nearest' } },
    { id: 'concat_0', type: 'Concat', position: { x: 300, y: 1480 }, params: { axis: 0 } },
    { id: 'c2f_4', type: 'C2f', position: { x: 300, y: 1600 }, params: { out_channels: 256, n: 2 } },
    { id: 'upsample_1', type: 'Upsample', position: { x: 300, y: 1720 }, params: { scale_factor: 2, mode: 'nearest' } },
    { id: 'concat_1', type: 'Concat', position: { x: 300, y: 1840 }, params: { axis: 0 } },
    { id: 'c2f_5', type: 'C2f', position: { x: 300, y: 1960 }, params: { out_channels: 128, n: 2 } },
    { id: 'conv_5', type: 'Conv', position: { x: 300, y: 2100 }, params: { out_channels: 128, kernel_size: 3, stride: 2 } },
    { id: 'concat_2', type: 'Concat', position: { x: 300, y: 2220 }, params: { axis: 0 } },
    { id: 'c2f_6', type: 'C2f', position: { x: 300, y: 2340 }, params: { out_channels: 256, n: 2 } },
    { id: 'conv_6', type: 'Conv', position: { x: 300, y: 2480 }, params: { out_channels: 256, kernel_size: 3, stride: 2 } },
    { id: 'concat_3', type: 'Concat', position: { x: 300, y: 2600 }, params: { axis: 0 } },
    { id: 'c2f_7', type: 'C2f', position: { x: 300, y: 2720 }, params: { out_channels: 512, n: 2 } },
    { id: 'detect_0', type: 'Detect', position: { x: 300, y: 2880 }, params: { num_classes: 80 } },
  ],
  edges: [
    // Backbone
...
/** YOLOv8-medium backbone + head (3x nano channels) */
export const YOLOV8_MEDIUM: GraphIR = {
  nodes: [
    { id: 'input_0', type: 'Input', position: { x: 300, y: 0 }, params: { channels: 3, height: 640, width: 640 } },
    { id: 'conv_0', type: 'Conv', position: { x: 300, y: 120 }, params: { out_channels: 48, kernel_size: 3, stride: 2 } },
    { id: 'conv_1', type: 'Conv', position: { x: 300, y: 240 }, params: { out_channels: 96, kernel_size: 3, stride: 2 } },
    { id: 'c2f_0', type: 'C2f', position: { x: 300, y: 360 }, params: { out_channels: 96, n: 2 } },
    { id: 'conv_2', type: 'Conv', position: { x: 300, y: 480 }, params: { out_channels: 192, kernel_size: 3, stride: 2 } },
    { id: 'c2f_1', type: 'C2f', position: { x: 300, y: 600 }, params: { out_channels: 192, n: 2 } },
    { id: 'conv_3', type: 'Conv', position: { x: 300, y: 720 }, params: { out_channels: 384, kernel_size: 3, stride: 2 } },
    { id: 'c2f_2', type: 'C2f', position: { x: 300, y: 840 }, params: { out_channels: 384, n: 2 } },
    { id: 'conv_4', type: 'Conv', position: { x: 300, y: 960 }, params: { out_channels: 768, kernel_size: 3, stride: 2 } },
    { id: 'c2f_3', type: 'C2f', position: { x: 300, y: 1080 }, params: { out_channels: 768, n: 1 } },
    { id: 'sppf_0', type: 'SPPF', position: { x: 300, y: 1200 }, params: { out_channels: 768, kernel_size: 5 } },
    // Head
    { id: 'upsample_0', type: 'Upsample', position: { x: 300, y: 1360 }, params: { scale_factor: 2, mode: 'nearest' } },
    { id: 'concat_0', type: 'Concat', position: { x: 300, y: 1480 }, params: { axis: 0 } },
    { id: 'c2f_4', type: 'C2f', position: { x: 300, y: 1600 }, params: { out_channels: 384, n: 2 } },
    { id: 'upsample_1', type: 'Upsample', position: { x: 300, y: 1720 }, params: { scale_factor: 2, mode: 'nearest' } },
    { id: 'concat_1', type: 'Concat', position: { x: 300, y: 1840 }, params: { axis: 0 } },
    { id: 'c2f_5', type: 'C2f', position: { x: 300, y: 1960 }, params: { out_channels: 192, n: 2 } },
    { id: 'conv_5', type: 'Conv', position: { x: 300, y: 2100 }, params: { out_channels: 192, kernel_size: 3, stride: 2 } },
    { id: 'concat_2', type: 'Concat', position: { x: 300, y: 2220 }, params: { axis: 0 } },
    { id: 'c2f_6', type: 'C2f', position: { x: 300, y: 2340 }, params: { out_channels: 384, n: 2 } },
    { id: 'conv_6', type: 'Conv', position: { x: 300, y: 2480 }, params: { out_channels: 384, kernel_size: 3, stride: 2 } },
    { id: 'concat_3', type: 'Concat', position: { x: 300, y: 2600 }, params: { axis: 0 } },
    { id: 'c2f_7', type: 'C2f', position: { x: 300, y: 2720 }, params: { out_channels: 768, n: 2 } },
    { id: 'detect_0', type: 'Detect', position: { x: 300, y: 2880 }, params: { num_classes: 80 } },
  ],
  edges: [
    // Backbone
