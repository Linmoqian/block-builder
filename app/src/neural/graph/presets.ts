...
export const YOLOV8_NANO: GraphIR = {
  nodes: [
    ...
    { id: 'concat_0', type: 'Concat', position: { x: 300, y: 1480 }, params: { axis: 1 } },
    ...
    { id: 'concat_1', type: 'Concat', position: { x: 300, y: 1840 }, params: { axis: 1 } },
    ...
    { id: 'concat_2', type: 'Concat', position: { x: 300, y: 2220 }, params: { axis: 1 } },
    ...
    { id: 'concat_3', type: 'Concat', position: { x: 300, y: 2600 }, params: { axis: 1 } },
